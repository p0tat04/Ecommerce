...
try {
  ...
  $all_products = [
    ['id' => 1, 'icon' => '📱', 'badge' => 'Sale', 'category' => 'Electronics', 'name' => 'Smartphone Pro X12',      'price' => '₱12,999', 'original' => '₱16,500', 'reviews' => '⭐⭐⭐⭐⭐ (142 reviews)'],
    ['id' => 2, 'icon' => '👟', 'badge' => '',     'category' => 'Footwear',    'name' => 'AirRun Classic Sneakers',  'price' => '₱2,499',  'original' => '',         'reviews' => '⭐⭐⭐⭐☆ (87 reviews)'],
    ['id' => 3, 'icon' => '💻', 'badge' => 'New',  'category' => 'Electronics', 'name' => 'UltraBook Slim 15"',       'price' => '₱34,500', 'original' => '₱38,000', 'reviews' => '⭐⭐⭐⭐⭐ (56 reviews)'],
    ['id' => 4, 'icon' => '⌚', 'badge' => '',     'category' => 'Accessories', 'name' => 'SmartWatch Series 7',       'price' => '₱4,299',  'original' => '',         'reviews' => '⭐⭐⭐⭐☆ (203 reviews)'],
    ['id' => 5, 'icon' => '🎧', 'badge' => 'Hot',  'category' => 'Electronics', 'name' => 'Wireless Earbuds Pro V3',  'price' => '₱1,899',  'original' => '₱2,499',  'reviews' => '⭐⭐⭐⭐⭐ (319 reviews)'],
    ['id' => 6, 'icon' => '👜', 'badge' => '',     'category' => 'Fashion',     'name' => 'Genuine Leather Handbag',  'price' => '₱3,750',  'original' => '',         'reviews' => '⭐⭐⭐⭐☆ (74 reviews)'],
    ['id' => 7, 'icon' => '🖱️', 'badge' => '',    'category' => 'Electronics', 'name' => 'Gaming Mouse RGB 16000dpi','price' => '₱1,250',  'original' => '',         'reviews' => '⭐⭐⭐⭐⭐ (198 reviews)'],
    ['id' => 8, 'icon' => '🌿', 'badge' => '',     'category' => 'Beauty',      'name' => 'Organic Skincare Set',     'price' => '₱899',    'original' => '',         'reviews' => '⭐⭐⭐⭐☆ (45 reviews)'],
  ];

  $categories = ['All', 'Electronics', 'Fashion', 'Home', 'Beauty', 'Footwear', 'Accessories'];
  $products = array_filter($all_products, function($p) use ($selected_cat, $search_query) {
      ...
      <div>
        ...
        <?php else: ?>
          ...
          <div style="display:flex;justify-content:center;gap:0.5rem;margin-top:2.5rem;">
            <a href="?page=<?= max(1, ($_GET['page'] ?? 1) - 1) ?>" class="btn btn-ghost btn-sm">← Prev</a>
            <?php for ($i = 1; $i <= 3; $i++): ?>
              <a href="?page=<?= $i ?>" class="btn <?= (($_GET['page'] ?? 1) == $i ? 'btn-primary' : 'btn-ghost') ?> btn-sm"><?= $i ?></a>
            <?php endfor; ?>
            <a href="?page=<?= ($_GET['page'] ?? 1) + 1 ?>" class="btn btn-ghost btn-sm">Next →</a>
          </div>
        <?php endif; ?>
      </div>
